    ...
    <script>
        ...
        function switchTab(tabName) {
            ...
            tabs.forEach(t => {
                ...
                if (t === tabName) {
                    btn.className = "tab-btn active border px-3 py-3 rounded-xl flex flex-col sm:flex-row items-center justify-center gap-1.5 sm:gap-2 text-xs md:text-sm font-semibold";
                    content.classList.remove('hidden');
                } else {
                    btn.className = "tab-btn inactive border px-3 py-3 rounded-xl flex flex-col sm:flex-row items-center justify-center gap-1.5 sm:gap-2 text-xs md:text-sm font-semibold";
