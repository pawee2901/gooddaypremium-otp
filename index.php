...
<body class="min-h-screen flex flex-col items-center justify-center p-4 md:p-6 bg-white selection:bg-black selection:text-white">
    ...
    <div class="w-full max-w-lg flex flex-col gap-6">
        ...
        <div id="resultBox" class="hidden bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden transform scale-95 opacity-0 transition-all duration-500 w-full">
            ...
            <div id="emailDetailView" class="hidden p-4 md:p-6 space-y-4">
                <div class="flex items-center justify-between border-b border-gray-50 pb-2">
                    <button onclick="showInboxList()" class="flex items-center gap-1.5 text-xs text-zinc-500 hover:text-black font-semibold transition-all">
                        <i class="fa-solid fa-chevron-left text-[9px]"></i>
                        <span>ย้อนกลับไปกล่องข้อความ</span>
                    </button>
                ...
                <div class="flex items-center gap-2 text-xs font-bold text-gray-800">
                    <i class="fa-solid fa-envelope-open-text text-sm text-gray-400"></i>
                    <span>📨 หน้าจอจดหมายฉบับจริงจากกล่องข้อความ (Email Preview)</span>
                </div>
                
                <div class="border border-gray-100 rounded-2xl overflow-hidden shadow-inner bg-white">
                    <iframe id="emailIframe" class="w-full h-[500px] border-0 bg-white" title="Email preview content"></iframe>
                </div>
    ...
    <script>
        ...
        function renderEmails(emails, appName) {
            ...
            emails.forEach((emailData, idx) => {
                ...
                card.onclick = () => openEmailDetail(idx);
